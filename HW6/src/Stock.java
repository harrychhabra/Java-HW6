...
public class Stock 
{
	...
	static void ascendingSort(StockHolding array[])
	{
		//selection sort
	...
	static void descendingSort(ForeignStockHolding array[])
	{
		//selection sort
		for(int i=0; i<array.length; i++)
		{
	...
	public static void main (String[] args)
	{
		...
		ascendingSort(stockHoldingArray);
		...
		descendingSort(foreignStockHoldingArray);
